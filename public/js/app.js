...
let roundround = function (array, index) {
    index = index || 0;
...
$(document).ready(function() {
    ...
    function changeProperty(i) {
        console.log(i);
        document.getElementById("property_name").innerHTML = i.name;
        document.getElementById("property_deed").innerHTML = i.title_deed;
