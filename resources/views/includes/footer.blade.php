    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="media-content">
            <div id="project-slider" class="owl-carousel owl-theme" style="display: block; opacity: 1;">
                <div class="owl-wrapper-outer autoHeight" style="height: 596px;"><div class="owl-wrapper" style="display: block; width: 5400px; left: 0px; transition: all 0ms ease; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 900px;"><div class="item"><img src="http://mikemagero.co.ke/wealthsmith/images/foothills.jpg" class="respimg"></div></div><div class="owl-item" style="width: 900px;"><div class="item"><img src="http://mikemagero.co.ke/wealthsmith/images/foothills.jpg" class="respimg"></div></div><div class="owl-item" style="width: 900px;"><div class="item"><img src="http://mikemagero.co.ke/wealthsmith/images/foothills.jpg" class="respimg"></div></div></div></div>
...
<script type="text/javascript" src="http://mikemagero.co.ke/wealthsmith/js/jpreloader.min.js"></script>
<script type="text/javascript" src="http://mikemagero.co.ke/wealthsmith/js/plugins.js"></script>
<script type="text/javascript" src="http://mikemagero.co.ke/wealthsmith/js/superslides.js"></script>
<script type="text/javascript" src="http://mikemagero.co.ke/wealthsmith/js/initslideshow.js"></script>
<script type="text/javascript" src="http://mikemagero.co.ke/wealthsmith/js/scripts.js"></script>
